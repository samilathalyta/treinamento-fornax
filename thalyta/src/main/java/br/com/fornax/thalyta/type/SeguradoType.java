package br.com.fornax.thalyta.type;
...
public String nome = null;
  ...
  @JsonProperty("seguro")
  @Valid
  private List<SeguroType> seguro = null;
...
@Size(max=150) 
  ...
  **/
  ...
  public SeguradoType seguro(List<SeguroType> seguro) {
    this.seguro = seguro;
    return this;
  }

  public SeguradoType addSeguroItem(SeguroType seguroItem) {
    if (this.seguro == null) {
      this.seguro = new ArrayList<SeguroType>();
    }
